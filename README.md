...
This attack works by identifying deniable behaviour in polynomial time by assuming all inter-message delays follow an exponential distribution. The limits of this approach is discussed in the thesis.
